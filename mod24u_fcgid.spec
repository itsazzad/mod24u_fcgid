...
%{!?_httpd_apxs: %global _httpd_apxs $(which apxs)}
...
BuildRequires:	httpd24u-devel >= 2.4, pkgconfig
...
%changelog
* Sat Feb 12 2016 Mustafa Ramadhan <mustafa@bigraf.com> 2.3.9-1
